...
def main(g_t,m,*a):    
    ...
    if t is 1:
        ...
        # 굳이 밀어 놓은 반대에서 부터 정렬할 필요가없음
        # 유레카 이거야

        fix = [i for i in sli1+sli2 if i not in hli]
        sli = [[4,9,14,19],[3,8,13,18],[2,7,12,17],[1,6,11,16],[0,5,10,15]]
        sli = sli[::-1] if b else sli
...
##    Type,m1,m2,a = 0,'051002426053060','510642030314000',[[0, 9, 14], [2, 6, 12]]
    Type,m1,m2,a = 1,'3600a4090b20105c8007','b8000539020a006c1740',[3, 8, 13]    
