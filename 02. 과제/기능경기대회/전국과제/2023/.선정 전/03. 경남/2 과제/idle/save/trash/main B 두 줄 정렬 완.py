    ...
    if t is 1:
        ...
        for ct,pos in enumerate(sli):
            ...
            if ct < 8:      # 바깥쪽 줄 한개씩 뿅
                ...
                # [그림판 1번],[그림판 2번]
                b1 = ct > 3 and ((n1 and abs(hli[1] - hli[2]) is 1) or n1 is 2)
                if b1:
                    b2 = y in [2,3]
            ...
            if not b1:      # [그림판 1번],[그림판 2번] 아닐 때
                if not ct or (ct in [4] and n < 4):       # 첫 번째 줄 첫 정렬, [그림판 3번]
                    li = [0,1,2,3,4] if y is 3 else [15,16,17,18,19]
                    li = [i for i in li if i not in fix]
                    m = bfs(2,m,li,[],-1)
                    fix += li
                if ct > 3 and n1 is 1 and n is 4:       # [그림판 4번]
...
##    Type,m1,m2,a = 0,'051002426053060','510642030314000',[[0, 9, 14], [2, 6, 12]]
    Type,m1,m2,a = 1,'a6b21890c00307005004','4200973060010a5b80c0',[9, 10, 7]
