...
class BFS:
    def __init__(self,board: str,mode: '0:EFP 1:Resolt'):
        self.br = board[:]
        self.mode = mode
    ...
    def bfs(self,Exit):
        ...
        node = '0'*16+'3' # index range Error
        def isDone(node):
            if self.mode: return node != '1111222299930000'
    ...
    def escape_parking_2(self,Exit):
        ...
        def convert(recode):
            ...
            return new_recode
        print(convert(recode))
        

result = BFS('1290392210112090',1)
randomExit = random.randrange(3,16,4)
result.escape_parking_2(3)
