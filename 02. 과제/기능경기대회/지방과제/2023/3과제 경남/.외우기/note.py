...
A = posing(posx(-220.72, 282.73, 14.7+60, 124.33, 179.99, 34.46),4,4)
C = posing(posx(79.23, 360.94, 14.92, 76.59, 180, -13.28),1,6)
itp = posx(298.42, 355.82, 81.72, 33.12, -179.7, -56.92)
gtp  =[posx(142.11, 540.36, 34.62, 75.39, -179.99, -14.63),
        posx(142.16-270, 540.45, 34.68, 74.48, 180, -15.55)]
