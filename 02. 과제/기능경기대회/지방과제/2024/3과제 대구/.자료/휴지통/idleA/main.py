...
def bfs(n,m,*a):
    ...
    while 1:
        ...
        if n == 1:
            ...
            if ((pos == -1 and cur1 == leaf) or (pos != -1 and cur1[pos] == pack)) and (t != 0 or (t == 0 and bfs(2,cur))):
                break
...
def sort(m,leaf,e,p=-1):        # A 파레트만 사용
    ...
    if pack != '0':
        ...
        if len(exp(0,m,e)) == 1 and m[0][e] != pack:        # SoImportantLine
            m = bfs(1,m,leaf,e,'0')
            fix.append(e)
...
def main(g_t,m,*a):    
    ...
    if t == 0:
        ...
        fp = leaf.index('x')
        area = [[0,1,4,5],[3,2,7,6],[12,8,13,9],[15,11,14,10]]
        n, = [i for i in range(4) if fp in area[i]]
        
        li = area[n] + [[2,8,3,12,6,9],
                        [1,11,0,15,5,10],
                        [4,14,0,15,5,10],
                        [7,13,3,12,6,9]][n]
        ...
        for i in li:
            pack = leaf[i]
            if pack == '0' or i in hold:         # 정렬 위치에 팩이 없을때 가까운 팩 찾기
...
if __name__ == '__main__':
    ...
    # r,l,dire = rdm(0)         # 랜덤 배치

    r,l,dire = '020bcxa765813904','6b102x50843907ac',0    
    # r,l,dire = '4xb150a06c703298','5x010a92bc478360',3

        
    print('Information ->',"r,l,dire = '{}','{}',{}".format(r,l,dire))
