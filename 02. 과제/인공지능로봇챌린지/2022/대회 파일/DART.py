...
set_velx(2500); set_accx(1800); begin_blend(20)
...
pos_A = posing(posx(-260.47, 191.24, 15.39, 95.44, 179.87, 5.4),6,4)
pos_B1 = posing(posx(368.19, 322.23, 19.34, 94.98, 179.87, 4.94),4,3)
pos_B2 = posing(posx(239.95, 401.7, 17.82, 95.6, 179.87, 5.56),3,4)
pos_C = [posx(-20.65, 523.23, 39.18, 95.8, 179.87, 5.76),posx(-140.84, 521.64, 39.43, 95.75, 179.87, 5.7)]
pos_D = [posx(-80.9, 332.17, 16.36, 95.67, 179.87, 5.63),posx(-120.75, 332.16, 16.6, 95.58, 179.87, 5.54)]
pos_index = posx(345.33, 256.75, 83.9, 21.67, -179.33, -68.56)
