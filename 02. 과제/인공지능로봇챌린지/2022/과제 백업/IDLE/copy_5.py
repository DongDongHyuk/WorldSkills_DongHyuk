...
class State_0:      # A Soring State
    ...
    def __init__(self,br,it,turn = 0,spin_count = 0,pack = '1'+'2',move_dire = None):
...
def exchange(state, now, new, it=None, turn=None, spin_count=None, B1orB2=None, move_dire=None):
    ...
    if not G_Type:
        ...
        return State_0(br,it,turn + 1,spin_count,pack,move_dire)         # new state
    else: 
...
def main(n):
    ...
    return result
print(main([1, ['0x10000x0000', '100000xx0000'], [0, 0], [2, 0], [4, 3]]))
