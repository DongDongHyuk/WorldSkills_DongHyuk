...
def Truedirs(mode:'find road or Sort'=0,br=None,pos=None):
    result = []
...
x_size = 12
br = '09x900x909090999x0900x909xx0xx0x9xx00x09099x0909909x900x90x990xx0x990900'
find_road_result = path(bfs_find_road(br,0,59)) # find road result
...
result[0] = converter(sort_result)
